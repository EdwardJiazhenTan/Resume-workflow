...
\begin{onecolentry}
    \begin{highlights}
        ...
        \item Built a responsive frontend with \textbf{Next.js} and \textbf{Tailwind CSS}, working cross-functionally with designers to deliver scalable, \textbf{Figma}-aligned SSR components using \textbf{React} and \textbf{HTML}/\textbf{CSS}
